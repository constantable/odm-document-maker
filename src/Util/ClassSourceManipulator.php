...
namespace Constantable\OdmDocumentMaker\Util;
...
use Constantable\OdmDocumentMaker\Doctrine\BaseCollectionReference;
use Constantable\OdmDocumentMaker\Doctrine\BaseReference;
use Constantable\OdmDocumentMaker\Doctrine\ReferenceMany;
use Constantable\OdmDocumentMaker\Doctrine\ReferenceManyToMany;
use Constantable\OdmDocumentMaker\Doctrine\ReferenceOne;
use Constantable\OdmDocumentMaker\Doctrine\ReferenceOneToOne;
...
final class ClassSourceManipulator
{
    ...
    public function addEmbedOne(\Constantable\OdmDocumentMaker\Doctrine\EmbedOne $embedding): void
    {
    ...
    public function addEmbedMany(\Constantable\OdmDocumentMaker\Doctrine\EmbedMany $embedding): void
    {
    ...
    private function addSingularRelation(BaseReference $relation): void
    {
        $target = $relation->getTargetDocument();
        ...
        if (($relation instanceof ReferenceOneToOne) && !$relation->isOwning()) {
    ...
    private function addCollectionRelation(BaseCollectionReference $relation): void
    {
        $target = $relation->getTargetDocument();
        ...
        if ($relation->isOwning()) {
            ...
            if ($relation instanceof ReferenceMany) {
            ...
            } elseif ($relation instanceof ReferenceManyToMany) {
    ...
    private function addNodesToSetOtherSideOfOneToOne(ReferenceOneToOne $relation, Builder\Method $setterNodeBuilder): void
    {
