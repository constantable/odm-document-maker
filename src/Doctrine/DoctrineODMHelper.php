...
final class DoctrineODMHelper
{
    ...
    public function doesClassUseDriver(string $className, string $driverClass): bool
    {
        try {
            ...
            // an example case is the "constantable:make-document" command, which needs to know which driver is used for the class to determine
    ...
    private function classToCollectionName($className): mixed
    {
